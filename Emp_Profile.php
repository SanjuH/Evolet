...
<body style="overflow-x:hidden">
   ...
   $flag=0;
    ...
    if ($numrows!=0) {
        while ($row =mysqli_fetch_assoc($result)) {
            ...
            if ($e==$_SESSION["username1"]) {
                ...
                echo'          <td width="57%">'.$row["edesig"].'</td>';
                echo'     </tr>';
                echo'     <tr>';
                echo'         <td align="left" valign="top" width="41%">Domain</td>';
                echo'          <td width="57%">'.$row["edomain"].'</td>';
                echo'       </tr>';
    ...
    if($flag!=1)
    {
        echo'<h1>Sorry,There Is No Record With Your Name In This Company Database</h1>';
        echo'<br>';
        echo'<h1>Check Whether You Work In The Right Company.</h1>';
    }
    ?>
   <div class="footer" style="top: 40px;position: relative;">
        <div >
