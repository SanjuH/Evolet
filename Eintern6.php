    ...
    <body style="overflow-x:hidden">
        ...
        if ($numrows!=0) {
            echo' <table class="table table-striped">';
                   ...
                   echo'  <th scope="col">Work Time Alloted</th>';
                   echo'  <th scope="col">Work Time Completed</th>';
            ...
            while ($row =mysqli_fetch_assoc($result)) {
                        ...
                        echo'   <td>'.$row["eid"].'</td>';
                        echo'   <td>'.$row["date"].'</td>';
                        echo'   <td>'.$row["twork"].' Hrs'.'</td>';
                        echo' <form method="post" action="Eintern5.php">';
                        echo' <input type="hidden" name="name" value="'.$row["iid"].'" />';
                        echo' <input type="hidden" name="name1" value="'.$row["date"].'" />';
                        echo' <input type="hidden" name="name2" value="'.$row["eid"].'" />';
                        echo'   <td>'.$row["dwork"].' Hrs'.'<button class="btn btn-lg pull-right" >View</button></td>';
