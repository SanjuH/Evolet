...
<body style="overflow-x:hidden">
    ...
    <br />
    <div>
        <p class="heading">SEARCH FOR EMPLOYEE USING NAME OR ID: </p>
    </div>
    <br />
    <br />
    <div >
        <form action="View_Employee.php" method="post">
        <input type="text" id="def" name="search">
        <button type="submit" id="lmn"class="btn btn-lg btn-outline-dark">Search</button>
    </form>
    </div>
    <br />
    <br />
    ...
    if ($numrows!=0) {
        while ($row =mysqli_fetch_assoc($result)) {
            ...
            if (($e==$e1)||($e==$e2)) {
                ...
                echo'   <tr>';
                echo'        <td colspan="2" align="center" id="abc"><b>EMPLOYEE PROFILE.</b></td>';
