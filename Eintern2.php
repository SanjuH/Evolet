...
<html>
    ...
    <body style="overflow-x:hidden">
        ...
        if ($numrows!=0) {
            ...
            while ($row =mysqli_fetch_assoc($result)) {
                ...
                if ($e1 == $id) {
                   ...
                   if ($ts==0) {
                       echo' <form method="post" action="Eintern3.php">';
                       echo' <input type="hidden" name="name" value="'.$id.'" />';
                       echo' <input type="hidden" name="name1" value="'.$row["cid"].'" />';
                       echo'   <td><button class="btn btn-lg " >Done</button></td>';
                       echo'</form>';
                   }
                   if($ts==1){
        ...
        if ($flag==1) {
            echo' <form method="post" action="Task.html">';
            echo' <input type="hidden" name="name" value="'.$id.'" />';
            echo'  <div style="position:relative;top:50px;left:760px">';
            echo'   <td><button class="btn btn-lg  " style="padding-left:40px;padding-right:40px;position:relative;left:0px;top:20px">Allocate Work</button></td>';
            echo'</div>';
            echo'</form>';
        }
        if($flag!=1)
        {   
            ...
            echo '<h1 style="text-align:center">This Intern Has Not Been Allocated Any Work</h1>';
            echo' <form method="post" action="Task.html">';
            echo' <input type="hidden" name="name" value="'.$id.'" />';
            echo'  <div style="position:relative;top:50px;left:760px">';
            echo'   <td><button class="btn btn-lg  " style="padding-left:40px;padding-right:40px">Allocate Work</button></td>';
            echo'</div>';
            echo'</form>';
            $_SESSION['tid']=$id;
