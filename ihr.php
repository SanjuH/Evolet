        ...
        if ($numrows!=0) {
            while ($row =mysqli_fetch_assoc($result)) {
                ...
                if ($id==$idt) {
                    ...
                    echo'   </tr>';
                    echo'   <tr style="height:45px">';
                    echo'      <td align="left" valign="top" width="41%">&nbsp;&nbsp;Internship Field<span></span></td>';

                    echo'    <td width="57%">'.$row["field"].'</td>';
                    echo'   </tr>';
                    echo'  <tr style="height:45px">';
                    ...
                    echo'        <p align="center">';
                    echo'            <br />';
                    echo'            <button class="btn btn-lg btn-outline-dark" id="upload" ><a href="sics.php">CALL FOR INTERVIEW</a></button>';
                    echo'             <br />';
                    echo'      </td>';
                    echo'   </tr>';
