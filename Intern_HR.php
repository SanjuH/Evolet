...
<body style="overflow-x:hidden;">
    <div class="img-align">
                ...
                <div class="container-fluid nav-align">
                    ...
                    <div class="collapse navbar-collapse nav-design" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="li"><a href="HR.html">EMPLOYEE <span class="sr-only">(current)</span></a></li>
        ...
        echo'<div>';
        echo'   <div class="headd">';
        echo'       <p class="heading">RESUME</p>';
        echo'   </div>';
        echo'   <div>';
        echo'     <table class="t1 table table-bordered" style="width:800px">';
        echo'          <tr id="th">';
        echo'          <td width="10%">Sl. No</td>';
        echo'          <td width="90%">Name</td>';
        $flag=0;
        $flag1=1;
        $sql1= "SELECT * from seintern";
        ...
        if ($numrows!=0) {
            while ($row =mysqli_fetch_assoc($result)) {
               ...
               echo' <form method="post" action="ihr.php">';
 echo' <input type="hidden" name="name" value="'.$id.'" />';
                echo'        <th width="90%">'.$name.' <button class="btn btn-lg pull-right view">View</button></th>';
                   echo'</form>';
                //     echo'     </tr>';
                    //     echo'     <tr height="10px">';
                    //     echo'     <td width="10%"></td>';
                    //     echo'      <td width="70%"><button class="btn btn-lg pull-right view">View</button></td>';
